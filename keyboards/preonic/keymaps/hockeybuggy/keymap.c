 ...
 * |      |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |Smile |Laugh |Think |TmbsUp|Metal |EM Dsh|   -  |   =  |   [  |   ]  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, EM_SMILE, EM_LAUGH, EM_THINKING, EM_THUMBS_UP,   EM_METAL,   EM_DASH,    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   EN_DASH, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
